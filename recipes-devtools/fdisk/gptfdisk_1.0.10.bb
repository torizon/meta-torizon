...
# "gptfdisk: remove recipe"): resize-helper (board-independent, this
# layer) hard-depends on sgdisk at runtime for GPT-partitioned
# machines, and meta-tegra's SD card flashing (make-sdcard.sh) needs
# it too. Drop this once resize-helper stops needing sgdisk.
